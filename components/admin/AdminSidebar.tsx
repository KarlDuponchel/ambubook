...
export function AdminSidebar({
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed top-0 left-0 z-50 h-screen bg-black border-r border-neutral-800 flex flex-col transition-all duration-300 shadow-xl",
      ...
      >
        ...
        <div className="relative flex items-center justify-between h-16 px-4 border-b border-neutral-800">
          <div className="absolute inset-0 bg-linear-to-r opacity-70" />
          <Link
            href="/admin"
            className={cn(
                ...
                <li key={item.href}>
                  ...
                  >
                    ...
                    {!isCollapsed && item.badge !== undefined && item.badge > 0 && (
                      <span className="px-2 py-0.5 text-xs font-medium bg-white text-black rounded-full">
                        {item.badge}
                      </span>
                    )}
                  </Link>
        ...
        <div className="border-t border-neutral-800 p-4">
          ...
          >
            <div className="h-10 w-10 rounded-2xl bg-white flex items-center justify-center shrink-0 ring-2 ring-neutral-800">
