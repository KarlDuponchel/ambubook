      ...
      <Container>
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="flex lg:flex-col gap-4 lg:gap-5 overflow-x-auto lg:overflow-visible snap-x snap-mandatory lg:snap-none -mx-4 px-4 lg:mx-0 lg:px-0 pb-2 lg:pb-0 hide-scrollbar">
              {features.map((feature) => (
                <div
                  key={feature.title}
                  className="flex flex-col lg:flex-row gap-3.5 lg:items-start shrink-0 lg:shrink min-w-[78%] sm:min-w-[45%] lg:min-w-0 snap-start bg-surface lg:bg-transparent border lg:border-0 border-line rounded-2xl lg:rounded-none p-5 lg:p-0"
                >
                  <span
