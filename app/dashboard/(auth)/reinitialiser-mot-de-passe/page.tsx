...
function ResetPasswordForm() {
        ...
        <div className="bg-white rounded-xl shadow-md p-8 border border-neutral-200">
          <div className="text-center">
            ...
            <Link
              ...
              className="inline-block bg-primary-600 text-white py-2.5 px-4 rounded-lg hover:bg-primary-700 transition-colors font-medium"
            >
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        router.push("/dashboard/connexion?reset=success");
      }, 3000);
    } catch {
      ...
      fallback={
        <div className="w-full max-w-md px-4">
          <div className="bg-white rounded-xl shadow-md p-8 border border-neutral-200 animate-pulse">
            <div className="h-8 bg-neutral-200 rounded w-2/3 mx-auto mb-4"></div>
